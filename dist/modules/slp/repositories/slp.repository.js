...
exports.SlpRepository = void 0;
const postgres_1 = require("../../../shared/db/postgres");
class SlpRepository {
    async aggregateStudentScores(courseId, weekId) {
    ...
    async saveRanking(records) {
      ...
      `;
            await postgres_1.pool.query(query, [
                r.student_user_id,
                r.scope,
                r.scope_id,
                r.period,
    ...
    async getStudentRankingHistory(studentUserId) {
        const query = `
      select *
      from ranking_records
...
exports.SlpRepository = SlpRepository;
