...
exports.LsmCourseRepository = void 0;
const postgres_1 = require("../../../shared/db/postgres");
class LsmCourseRepository {
    async findStudentCourseInfos(studentId) {
    ...
    async findStudentPendingWeeks(studentId) {
        const result = await postgres_1.pool.query(`
      SELECT
        st.class_id,
    ...
    async findClassCourseInfoByClassCode(classCode) {
        const result = await postgres_1.pool.query(`
      SELECT
        cc.avatar_url,
        cc.class_name,
...
exports.LsmCourseRepository = LsmCourseRepository;
